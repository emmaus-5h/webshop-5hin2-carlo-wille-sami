...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name, products.description AS description, products.price AS price, company.nameC, products.maat AS maat FROM products JOIN company WHERE products.company = company.id ORDER BY products.id')
...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name, products.description AS description, products.price AS price, company.nameC, products.maat AS maat FROM products JOIN company WHERE products.company = company.id AND id = ?')
