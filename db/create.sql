...
-- TABLE review
insert into review (nameR, amount_stars, description, personen_id) values ('Jacob R.', '4star', 'I recently got into cubing and thought it would be neat to have a 2x2, so i bought this one. overall it pretty good. turns very fast, but is a little bit sandy out of the box, butafter adding lube it is perfectly fine. definately worth the price', 1);
insert into review (nameR, amount_stars, description, personen_id) values ('that o.k.', '5star', 'This cube came out of the both very rough and weird, but when I lubed it with speed lube, it turned into the smoothest thing ever. The corner cutting can be improved by loosening it, and the magnets are easily adjustable (although I think the factory settings are strong and good enough).', 2);
insert into review (nameR, amount_stars, description, personen_id) values ('Anonymous', '5star', 'this is the best cube I ever felt!!!!!!!!!!!!', 3);
insert into review (nameR, amount_stars, description, personen_id) values ('Jude', '5star', 'Great cube as it satisfied my expectations. Very smooth, fast and quiet', 4);
insert into review (nameR, amount_stars, description, personen_id) values ('Jacob R.', '5star', 'The RS3M is a very good cube. for 9$, it can still pack a good tensioning system and magnets, although they are pretty weak. Corner cutting is also very good. It is slow turning, even on the lowest setting, but if you put a fast lube in (which I don’t have), it will probably be faster. Either than that, the cube is great.', 1);
insert into review (nameR, amount_stars, description, personen_id) values ('Alexandra L.', '3star', 'Its ok, but not super good. too messy and also breaks too much', 5);
insert into review (nameR, amount_stars, description, personen_id) values ('Jude', '5star', 'The cube was super small so I can hold it well. The speed was great and I put dingatas and gravitas in the outers. Then put some dnm and outers and inners so it was balanced. The cube allowed me to get amazing times', 4);
insert into review (nameR, amount_stars, description, personen_id) values ('Julian O.', '4star', 'Amazing cube for the price great for beginners and veteran’s alike', 6);
insert into review (nameR, amount_stars, description, personen_id) values ('Wyatt B.', '5star', 'Big fan of the AoSu WRM 4x4 so wanted to give this a try. By far the best 5x5 I have tried to date.', 9);
insert into review (nameR, amount_stars, description, personen_id) values ('Anonymous', '3star', 'I know its a budget cube, but from the other reviews, I kind of expected a little more on the quality side... But... you will get what you pay for on this one. Its rough out of the box, and not much better after lube. But I guess its fine if you just want a cheap, screw-around kind of 5x5.', 3);
insert into review (nameR, amount_stars, description, personen_id) values ('ME', '1star', 'IT HARD TO TURN IT ALMOST POP BAD CUBE', 10);
insert into review (nameR, amount_stars, description, personen_id) values ('Patricia A.', '5star', 'Grandson was very pleased!', 11);
insert into review (nameR, amount_stars, description, personen_id) values ('Hagop S.', '2star', 'this Megaminx sucks all around dont get it', 12);
insert into review (nameR, amount_stars, description, personen_id) values ('Ryan Y.', '2star', 'Ive tightened it up all the way but is still feels flimsy and the magnets are no good either DONT BUY THIS GET ANYTHING ELSE', 8);
insert into review (nameR, amount_stars, description, personen_id) values ('Big G.', '4star', 'It had a lot of catches out of the box and it was really dry. With some breaking in and setup, it becomes really good.', 13);
insert into review (nameR, amount_stars, description, personen_id) values ('henry b.', '5star', 'i got this for christmas and it was amazing out of the box. no need for tentoning but good overal. want to put dnm 37 in it to make it rediulacly fast so yeah', 14);
insert into review (nameR, amount_stars, description, personen_id) values ('Anonymous', '4star', 'Great skewb, and much better than the wingy v1 while still retaining its classic stability and feel, but its corner-cutting and fluidity is just not up-to-par with the gan. Also, the magnets on the strongest settings are still very weak in my opinion.', 3);
insert into review (nameR, amount_stars, description, personen_id) values ('Alexandra L.', '5star', 'This is definetly the best clock on the market. It is really smooth and the magnets help a lot.', 5);
insert into review (nameR, amount_stars, description, personen_id) values ('magic_cuber', '5star', 'I knew from other reviews and videos that this cube turned but wow, this is so much better then I expected. Solving it I had only 2 pops and they were easy to fix. It turns so smooth and doesnt even feel like it is gonna break. While it does have quite the price Im glad it is in my collection and can be used for patterns and fun patient solves.', 7);
insert into review (nameR, amount_stars, description, personen_id) values ('Ryan Y.', '4star', 'Definitely better than the Shengshou but didnt blow me away. If you want a gigaminx, this is the one to get, but dont expect too much.', 8);
insert into review (nameR, amount_stars, description, personen_id) values ('Julian O.', '5star', 'Very good timer. Just make sure to use two pad mode.', 6);
insert into review (nameR, amount_stars, description, personen_id) values ('magic_cuber', '3star', 'I don’t care for this lube too much, I don’t think it’s bad but I don’t think it’s that great either. Maybe there’s a specific lube combination that I’m not applying but I rather use other lubes like Silk to substitute it.', 7);
insert into review (nameR, amount_stars, description, personen_id) values ('Ismail N.', '3star', 'Not a great sweater for the price. The logos are faded and the sweater pockets are small. The quality of the fabric could be better considering it’s 40 bucks.', 15);
insert into review (nameR, amount_stars, description, personen_id) values ('Alexandra L.', '5star', 'Like everything else from the Cubicle, excellent!', 5);
insert into review (nameR, amount_stars, description, personen_id) values ('Julian O.', '1star', 'Backpack zipper will split open. Had the backpack for 7 weeks. Seen light usage, and the zipper split open, from behind the zipper pull.', 6);
